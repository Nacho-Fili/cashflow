...
export class InvestmentAccountMapper {
  toEntity(createInvestmentAccountDto: CreateInvestmentAccountDto): InvestmentAccount {
  ...
  updateEntityFromDto(account: InvestmentAccount, updateDto: UpdateInvestmentAccountDto): InvestmentAccount {
